  ...
  try {
    ...
    switch (event.type) {
      ...
      case "customer.subscription.updated": {
        ...
        console.log(`[Webhook TEST] Stripe status: ${subscription.status}, cancel_at_period_end: ${subscription.cancel_at_period_end}`);
      ...
      case "invoice.payment_succeeded": {
        ...
        else console.log("[Webhook TEST] Status set to active");
        break;
      }
